 ...
 *
 * $Id: ColorFileProcessor.java,v 1.12 2006/02/07 11:04:00 goldin Exp $
 * $Log: ColorFileProcessor.java,v $
 * Revision 1.12  2006/02/07 11:04:00  goldin
 * Handle blank color file name
 *
...
public class ColorFileProcessor
    ...
    public ColorFileProcessor(String clfFile)
        ...
        if ((clfFile != null) && (clfFile.length() > 0))
            init(clfFile);
	else
	    {
            for (int i = 0; i < 256; i++)
