 ...
 * WARRANTIES.
 * 
 * RCS: @(#) $Id: PackerLayout.java,v 1.5.4.1 2015/01/01 13:51:54 rudahl Exp $
 *
 */
...
public class PackerLayout implements LayoutManager
{
  ...
  private Hashtable<Component,PackRecord> component_table;
  private Component firstcomp, lastcomp;

  //this hashtable will do the mapping between
  //options and the actual option object

  private static Hashtable<String,Object> option_table;

  //this hashtable will do the mapping between
  //option arguments and the option that they
  //are valid for

  private static Hashtable<String,String> value_table;
  ...
  private static Hashtable<String,Object> value_object_table;
  ...
  static {
    ...
    option_table = new Hashtable<String,Object>(17);
    value_table = new Hashtable<String,String>(17);
    value_object_table = new Hashtable<String,Object>(17);
   ...
   */
  public PackerLayout() {    
    component_table = new Hashtable<Component,PackRecord>();
    firstcomp = null;
    lastcomp = null;
   ...
   * @param spec information about attachments
  ...
  public void addLayoutComponent(String spec, Component comp)
    ...
    if ((args.length % 2) != 0)
      {
	throw new PackingException("Fatal error in PackerLayout string spec, "
	...
	if (option == INT_MAP) 
	...
	else
	  {
	    ...
	    if (value == null) 
	      {
		String str = "null value object for option parser on "
		             +"option \"" +
			     args[i] + "\" : \"" + args[i+1] + "\"";
		throw new RuntimeException(str);
	      }
  ...
  public void removeLayoutComponent(Component comp) 
      ...
      if (prev == null)
	  { // we are removing the first component
	  firstcomp = next;
	  } 
      else
	  {           //remove next pointer from prev component
      ...
      if (next == null)
	  { // we are removing the last component
	  lastcomp = prev;
	  }
      else
	  {            //remove prev pointer from next component
   ...
   */
	...
	for (i = 0; i < nmembers; i++)
	    ...
	    if (pr == null)
	        {
		throw new RuntimeException("null PackRecord for "
					   +m.toString());
		//break;
		}
